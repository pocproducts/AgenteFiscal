...
export function SidebarHistory({ user }: { user: PanelUser | undefined }) {
  ...
  return (
    <>
        ...
        <SidebarGroupContent>
          ...
          {hasReachedEnd ? null : (
            <div className="mt-1 flex flex-row items-center gap-2 px-4 py-2 text-sidebar-foreground/50">
              ...
              <div className="text-[11px]">{nav.loading}</div>
            </div>
          )}
        </SidebarGroupContent>
      </SidebarGroup>
      ...
      <AlertDialog onOpenChange={setShowDeleteDialog} open={showDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>{nav.deleteTitle}</AlertDialogTitle>
            <AlertDialogDescription>
              {nav.deleteDescription}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>{nav.cancel}</AlertDialogCancel>

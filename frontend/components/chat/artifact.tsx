              ...
              <div className="flex items-center gap-2">
                {isContentDirty ? (
                  <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                    ...
                    {t.panel.chat.document.updating}
                  </div>
                ) : document ? (
                  <div className="text-xs text-muted-foreground">
                    {`${t.panel.chat.document.updated} ${formatDistance(new Date(document.createdAt), new Date(), { addSuffix: true })}`}
                  </div>
                  ...
                  <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                    ...
                    {t.panel.chat.document.creating}
                  </div>
                ) : (

...
export function VisibilitySelector({
  ...
  const visibilities: Array<{
    ...
    {
      id: "private",
      label: t.panel.chat.visibilities.private.label,
      description: t.panel.chat.visibilities.private.description,
      icon: <LockIcon />,
    },
    {
      id: "public",
      label: t.panel.chat.visibilities.public.label,
      description: t.panel.chat.visibilities.public.description,
      icon: <GlobeIcon />,
    },
  ];

...
from agente_fiscal.adapters.memory.models import TenantContext
from agente_fiscal.domain.models import ImpuestoInscripto, RegistroImpuesto, RentasCordobaMatching

logger = logging.getLogger(__name__)

#: idImpuesto del padrón que corresponden a IIBB — copiado de
#: ``agente_fiscal.matching._IIBB_IDS`` para mantener el refactor autocontenido.
...
class TenantBrain:
	...
	def _match_rentas(
		...
		Refactor de ``agente_fiscal.matching.evaluar_rentas_cordoba()`` como

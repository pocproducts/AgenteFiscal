...
def app() -> FastAPI:
	...
	from agente_fiscal.api.routes.health import router
...
class TestRedisFailure:
	...
	@patch('agente_fiscal.api.routes.health._check_redis')
	def test_redis_down(
		self,
...
class TestTaFailure:
	...
	@patch('agente_fiscal.api.routes.health._check_ta')
	def test_ta_expired(
		self,
...
class TestComposioFailure:
	...
	@patch('agente_fiscal.api.routes.health._check_composio')
...
class TestMultipleFailures:
	...
	@patch('agente_fiscal.api.routes.health._check_redis')
	@patch('agente_fiscal.api.routes.health._check_engram')
	@patch('agente_fiscal.api.routes.health._check_ta')
	@patch('agente_fiscal.api.routes.health._check_composio')

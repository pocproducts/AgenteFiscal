...
from agente_fiscal.api.middleware.metrics import EndpointMetrics, RequestMetricsStore
...
def app(metrics_store: RequestMetricsStore) -> FastAPI:
	from agente_fiscal.api.middleware.metrics import RequestMetricsMiddleware
